...
// DishItem(104, 'Trà Sữa Lài Kem Trứng Cháy', 29000, 'assets/icons/burger_beer.svg'),
...
// DishItem(107, 'Olong Sữa Kem Trứng Cháy', 29000, 'assets/icons/burger_beer.svg'),
...
// DishItem(204, 'Trà Olong Thiết Quan Âm', 15000, 'assets/icons/burger_beer.svg')
// ];
...
// DishItem(404, 'Sữa Tươi Khoai Môn Trân Châu', 35000, 'assets/icons/burger_beer.svg')
];

// cac mon an thuoc loai 5
List<DishItem> itemofType05 = [
  DishItem(501, 'Thanh Trà Đào Tươi', 27000, 'assets/images/501.png'),
// DishItem(502, 'Trà Đào Cam Sả Nha Đam', 39000, 'assets/icons/burger_beer.svg'),
  DishItem(
...
// DishItem(702, 'Kimbap Truyền Thống - 6 Cuộn', 20000, 'assets/icons/burger_beer.svg'),
...
// DishItem(804, 'Mì Trộn Thanh Cua Chiên Ù', 49000, 'assets/icons/burger_beer.svg'),
// DishItem(805, 'Mì Trộn Gà Sốt Teriyaki', 52000, 'assets/icons/burger_beer.svg'),
...
// DishItem(1501, 'Salad Bò Sốt Dầu Giấm', 45000, 'assets/icons/burger_beer.svg'),
// DishItem(1502, 'Salad Trứng Sốt Mayonnaise', 35000, 'assets/icons/burger_beer.svg')
];
...
// DishItem(1603, 'Tuyệt Đỉnh Món Hàn - Set 3', 72000, 'assets/icons/burger_beer.svg'),
// DishItem(1604, 'Tuyệt Đỉnh Món Hàn - Set 4', 74000, 'assets/icons/burger_beer.svg'),
// DishItem(1605, 'Tuyệt Đỉnh Món Hàn - Set 5', 78000, 'assets/icons/burger_beer.svg'),
// DishItem(1606, 'Tuyệt Đỉnh Món Hàn - Box 6', 149000, 'assets/icons/burger_beer.svg'),
// DishItem(1607, 'Tuyệt Đỉnh Món Hàn - Box 7', 179000, 'assets/icons/burger_beer.svg'),
  DishItem(
...
List<DishCategory> dishCategory = [
  ...
  // DishCategory(2, 'TRÀ NGUYÊN CHẤT',                  'assets/icons/chinese_noodles.svg', itemofType02),
